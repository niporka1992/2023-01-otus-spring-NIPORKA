...
public class DatabaseChangelog {
    ...
    public DatabaseChangelog() {
        ...
        comments.add(new Comment("g0", "text0"));
        comments.add(new Comment("g1", "text1"));
        comments.add(new Comment("g2", "text2"));
        ...
        books.add(new Book("b3", "Парфюмер", authors.get(2), genres.get(1), Collections.emptyList()));
