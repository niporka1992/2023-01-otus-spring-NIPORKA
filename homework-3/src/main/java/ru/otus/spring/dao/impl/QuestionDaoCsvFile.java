...
public class QuestionDaoCsvFile implements QuestionDao {
    ...
    public QuestionDaoCsvFile(QuestionResourceNameProvider questionResourceNameProvider, ResourceLoader resourceLoader) {
        this.questionResourceNameProvider = questionResourceNameProvider;
